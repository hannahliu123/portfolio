...
async function showAboutMeUpdates(aboutMeUpdates) {
    ...
    projects.innerHTML = aboutMeUpdates.projects;
    cp.innerHTML = aboutMeUpdates.cp;
    robotics.innerHTML = aboutMeUpdates.robotics;
    fencing.innerHTML = aboutMeUpdates.fencing;
    guzheng.innerHTML = aboutMeUpdates.guzheng;
    reading.innerHTML = aboutMeUpdates.reading;
    baking.innerHTML = aboutMeUpdates.baking;
}
